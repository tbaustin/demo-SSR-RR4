          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                dispatch({
                  type: _constants2.default.FETCH_CURRENT_USER,
                  payload: res
                });
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                dispatch({
                  type: _constants2.default.FETCH_ADMINS,
                  payload: res
                });
  ...
  var promises = (0, _reactRouterConfig.matchRoutes)(_Routes2.default, req.path).map(function (_ref) {
    ...
    if (promise) {
      return new Promise(function (resolve, reject) {
        promise.then(resolve).catch(resolve); // lets all data to be loaded
      });
    }
  });
...
exports.default = {
  ...
  loadData: function loadData(_ref2) {
    ...
    return dispatch(_actions2.default.fetchCurrentUser());
  }
};
...
var dispatchToProps = function dispatchToProps(dispatch) {
  return {
    fetchUsers: function fetchUsers() {
      return dispatch(_actions2.default.fetchUsers());
    }
  };
};
...
var dispatchToProps = function dispatchToProps(dispatch) {
  return {
    fetchAdmins: function fetchAdmins() {
      return dispatch(_actions2.default.fetchAdmins());
    }
  };
};

var loadData = function loadData(store) {
  return store.dispatch(_actions2.default.fetchAdmins());
};

exports.default = {
  component: (0, _reactRedux.connect)(stateToProps, dispatchToProps)((0, _requireAuth2.default)(AdminsListPage)),
  loadData: loadData
};
...
exports.default = function () {
  ...
  switch (action.type) {
    case _constants2.default.FETCH_CURRENT_USER:
...
exports.default = function () {
  ...
  switch (action.type) {
    case _constants2.default.FETCH_ADMINS:
      return action.payload.data;
    default:
      return state;
  }
